...
class ModelEvaluator():
    ...
    def get_single_image_results(self, gt_boxes, pred_boxes, iou_thr):
        ...
        if len(all_pred_indices)==0 or len(all_gt_indices)==0:
            tp=0
            fp=0
            fn=0
    ...
    def  get_avg_precision_at_iou(self, gt_boxes, pred_bb, iou_thr=0.5):
        ...
        for ithr, model_score_thr in enumerate(sorted_model_scores[:-1]):
            ...
            for img_id in img_ids:
                ...
                print(img_id)
                img_results[img_id] = self.get_single_image_results(gt_boxes_img, pred_boxes_pruned[img_id]['boxes'], iou_thr=0.5)
...
def test_calculation():
    ...
    """
    #GT Boxes
    gt_boxes= {"img_00285.png": [[10, 10, 30, 30]]}
    #Pred Boxes
    pred_boxes={"img_00285.png": {"boxes": [[20, 20, 40, 40]], "scores": [0.9739]}}
    
    me = ModelEvaluator()
    print(me.get_avg_precision_at_iou(gt_boxes, pred_boxes))
