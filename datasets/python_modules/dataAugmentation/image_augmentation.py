...
class ImageAugmentation():
    ...
    def load_image_bbs(self, xml_path, img_shape):
        """
        Load image bounding boxes from XML file. 
        """
    ...
    def save_new_image_label(self, basic_xml_path, filename_ext, bounding_boxes):   
        """
        Save image annotation to XML file. 
        """
    ...
    def augmentate_image_file(self, image_path, show_results=False, show_bbs=True):
        """
        Run every annotation mode for one image file. 
        """
    ...
    def show_saved_results(self,basic_image_path):
        """
        Load saved images and show them on screen. 
        """
        self.with_visualisation = False
    ...
    def show_images(self, images, titles=None, bounding_boxes=None):
        """
        Create a subplot for every augmentation mode and show the created images. 
        """
        img_per_row = 3
    ...
    def save_xml(self, root, targetFile):
        """
        Save informations as prettified XML.
        """
        out_file = None
...
if __name__ == "__main__":
    ...
    file_path = os.path.join(input_dir, "test1_cronjob_2020-10-01_09-42-40_62.png")
